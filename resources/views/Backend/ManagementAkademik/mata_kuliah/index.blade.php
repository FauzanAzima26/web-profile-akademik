...
@section('content')
    <div class="container-fluid">
        ...
        <table class="table table-bordered table-striped" id="MkTable" data-url="{{ route('mata.kuliah.data') }}">
            <thead>
                <tr>
                    <th width="50">No</th>
                    <th>Kode</th>
    ...
    @include('Backend.ManagementAkademik.mata_kuliah.ModalAddData')

    {{-- Modal Sampah / Restore --}}
    @include('Backend.ManagementAkademik.mata_kuliah.BaruDihapus')

    @push('scripts')
        <script src="{{ asset('assets/backend/js/mk.js') }}"></script>
    @endpush
@endsection
