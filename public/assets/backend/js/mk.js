$(function () {
    ...
    let updateUrl = "/management-akademik/mata/kuliah";

    let Table = $("#MkTable").DataTable({
        processing: true,
        serverSide: true,
        ajax: $("#MkTable").data("url"),
        columns: [
            {
                data: "DT_RowIndex",
                name: "DT_RowIndex",
    ...
    $("#formCreate").on("submit", function (e) {
        ...
        let id = $("#Mk_id").val(); // ambil id, kosong = tambah
    ...
    $(document).on("click", ".editBtn", function () {
        ...
        $.get("/management-akademik/mata/kuliah/" + id, function (res) {
            let data = res.data;
    ...
    $(document).on("click", ".deleteBtn", function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "/management-akademik/mata/kuliah/" + id,
    ...
    function fetchSampah() {
        $.ajax({
            url: "/management-akademik/mata/kuliah/sampah",
            type: "GET",
            success: function (res) {
                let tbody = "";
    ...
    $(document).on("click", ".restore-btn", function () {
        ...
        $.ajax({
            url: `/management-akademik/mata/kuliah/${id}/restore`,
            type: "POST",
            success: function (res) {
                alert(res.message);
    ...
    $(document).on("click", ".delete-btn", function () {
        ...
        $.ajax({
            url: `/management-akademik/mata/kuliah/${id}/force-delete`,
            type: "POST",
            data: {
                _method: "DELETE",
                _token: $('meta[name="csrf-token"]').attr("content"),
